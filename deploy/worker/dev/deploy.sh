...
FS_CDN_WORKER_SHUTDOWN_TIMEOUT_MS=$(get_value "FS_CDN_WORKER_SHUTDOWN_TIMEOUT_MS")
...
PY
  ...
  sed -i.bak \
    ...
    -e "s|__FS_CDN_WORKER_SHUTDOWN_TIMEOUT_MS__|${FS_CDN_WORKER_SHUTDOWN_TIMEOUT_MS}|g" \
