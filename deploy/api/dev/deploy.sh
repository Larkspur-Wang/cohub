...
SANDBOX_RUNTIME_IMAGE=${OVERRIDE_SANDBOX_IMAGE:-$(get_value "SANDBOX_RUNTIME_IMAGE")}
RUNTIME_STORAGE_ROOT=$(get_value "RUNTIME_STORAGE_ROOT")
RUNTIME_STORAGE_PVC=$(get_value "RUNTIME_STORAGE_PVC")
...
PY
  ...
  sed -i.bak \
    ...
    -e "s|__RUNTIME_STORAGE_ROOT__|${RUNTIME_STORAGE_ROOT}|g" \
    -e "s|__RUNTIME_STORAGE_PVC__|${RUNTIME_STORAGE_PVC}|g" \
