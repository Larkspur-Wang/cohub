      ...
      {:else if userUuid}
        <div class="py-6">
          <div class="flex items-center gap-3">
            ...
            {/if}
            <div class="min-w-0">
              <div class="truncate text-[15px] font-medium text-text-primary">{displayName || "User"}</div>
              <div class="mt-0.5 text-[12px] text-text-tertiary">Public profile</div>
            </div>
          </div>
          ...
          <div class="mt-8 border-t border-border-subtle pt-5">
            ...
            <div class="flex items-center gap-2">
              ...
              <button
                type="button"
                onclick={copyUuid}
                class="shrink-0 p-2 rounded-[5px] text-text-tertiary hover:bg-bg-hover hover:text-text-secondary transition-colors cursor-pointer"
                title="Copy UUID"
              >
                {#if uuidCopied}
