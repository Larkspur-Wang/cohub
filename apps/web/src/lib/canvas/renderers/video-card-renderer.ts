...
import type { CanvasItem, CanvasVideoItem } from "$lib/canvas/canvas-schema";
...
export const videoCardRenderer: CanvasCardRenderer = {
	id: "video-card",
...
export function isVideoItem(item: CanvasItem): item is CanvasVideoItem {
