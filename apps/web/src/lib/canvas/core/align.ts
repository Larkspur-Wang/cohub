...
import type { CanvasFrame } from "$lib/canvas/canvas-schema";
...
export function alignFrames(
	...
	const next = new Map<string, CanvasFrame>();
...
export function framesBounds(frames: Iterable<CanvasFrame>): Rect | null {
