...
app.use(
  cors({
    ...
    allowHeaders: ["Content-Type", "Authorization", "X-Git-Token", "X-Request-Id", "Traceparent", "Tracestate", "Baggage"],
    exposeHeaders: ["X-Request-Id", "X-Trace-Id", "X-Span-Id", "Traceparent", "Tracestate", "Baggage"],
    credentials: true,
  }),
);
